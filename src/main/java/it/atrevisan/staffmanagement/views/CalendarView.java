...
//
//                Span s = new Span(a.getPersonDocumentId() + " - " + a.getReason());
...
//
//                // tooltip strutturato in HTML
//                String tooltipHtml = "<b>Person:</b> " + personInfo + "<br>" +
//                        "<b>Reason:</b> " + a.getReason() + "<br>" +
//                        "<b>Date:</b> " + a.getDate();
//                s.getElement().setProperty("innerHTML", s.getText());
//                s.getElement().setAttribute("title", tooltipHtml); // fallback semplice browser
//
//                spans.add(s);
//            }
//        }
...
//                Span s = new Span(c.getPersonDocumentId() + " START");
...
//
//                String tooltipHtml = "<b>Person:</b> " + personInfo + "<br>" +
//                        "<b>Start Date:</b> " + c.getStartDate() + "<br>" +
//                        "<b>Job Role:</b> " + c.getJobRole();
//                s.getElement().setAttribute("title", tooltipHtml);
//                spans.add(s);
//            }
//            if (c.getEndDate() != null && date.equals(c.getEndDate())) {
//                String personInfo = getPersonInfo(c.getPersonDocumentId());
//                Span s = new Span(c.getPersonDocumentId() + " END");
...
//                String personInfo = getPersonInfo(c.getPersonDocumentId());
//                Span s = new Span(c.getPersonDocumentId() + " LICENSE");
...
//
//                String tooltipHtml = "<b>Person:</b> " + personInfo + "<br>" +
//                        "<b>License Expiry:</b> " + c.getLicenseExpiry() + "<br>" +
//                        "<b>Job Role:</b> " + c.getJobRole();
//                s.getElement().setAttribute("title", tooltipHtml);
//                spans.add(s);
//            }
